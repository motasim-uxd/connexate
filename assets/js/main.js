...
gsap.registerPlugin(ScrollTrigger);
  ...
  ScrollTrigger.matchMedia({
    // Only apply sticky behavior for medium and up
  ...
  $(window).on("scroll", function () {
    ...
    var threshold = $(".header__top").outerHeight(); // = 62px or dynamic

    if (scrollTop >= threshold) {
      $(".header__bottom").addClass("is-sticky");
    } else {
      $(".header__bottom").removeClass("is-sticky");
    }
  });
